...
import com.example.joongwonkim.somulbo2.NMap.NMapCalloutCustomOldOverlay;
import com.example.joongwonkim.somulbo2.NMap.NMapPOIflagType;
import com.example.joongwonkim.somulbo2.NMap.NMapViewerResourceProvider;
...
import com.example.joongwonkim.somulbo2.dbconnection.DownloadCallback;
import com.example.joongwonkim.somulbo2.dbconnection.VolleyRequestSingleInstance;
 ...
 * @author kyjkim
 */
public class NmapActivity extends NMapActivity implements DownloadCallback {
        ...
        for(int i =0; i < poiData.count(); i++ ) {
            ...
            stringRequest = new StringRequest(Request.Method.GET,  url,
                    response -> {
                        ...
                        Okjson asshole = gson.fromJson(response , Okjson.class);//                        updateFromDownload(addr);
